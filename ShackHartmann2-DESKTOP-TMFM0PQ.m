...
[aryFlatCx, aryFlatCy, I_temp] = HS_SubCentroidAry1(flatWave, valueAry, mask1, wl, L_pixel, subPixel,3e-3, b_digital, nBytes);
...
for nmode = 1 : numMode
    ...
    [aryTempCx, aryTempCy, I_temp] = HS_SubCentroidAry1(curMode, valueAry,mask1, wl, L_pixel, subPixel,3e-3, b_digital, nBytes);
...
[aryActCx1, aryActCy1, I_act1] = HS_SubCentroidAry1(wf, valueAry,mask1, wl, L_pixel, subPixel,3.5e-3, b_digital, nBytes);
slopvec1=6*HS_SubShiftVec1(aryActCx1,aryActCx, aryActCy1, aryActCy, valueAry);
% re_coe1=R_inv*slopvec;
% slopvec=HS_SubShiftVec1(aryActCx,aryFlatCx, aryActCy, aryFlatCy, valueAry);
%%
randcoe1=[0,0,0,0,5,0,0,0,0,0,0]';
...
[aryActCx, aryActCy, I_act] = HS_SubCentroidAry1(wf1, valueAry,mask1, wl, L_pixel, subPixel,3e-3 ,b_digital, nBytes);
 ...
 slopvec2=6*HS_SubShiftVec1(aryActCx1,aryActCx, aryActCy1, aryActCy, valueAry)-slopvec1     ;
slopvec=HS_SubShiftVec1(aryActCx,aryFlatCx, aryActCy, aryFlatCy, valueAry);
re_coe2=R_inv*slopvec2;
