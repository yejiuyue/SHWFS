function [arydSubCentroidX, arydSubCentroidY, I_total] = HS_SubCentroidAry2(arydWf, aryuValueAry, aryuValueArea, lamda, pixel, numSubPixel,f_microlens, b_digital, nBytes)
...
%             arydSubE = aryuCircleSub.*exp(1i*2*pi*arydSubWf);
               ...
               arydSubI_temp= propagpectrum1(arydSubE,L,lamda,f_microlens,3e-3);
        %     arydSubI_temp = abs(fftshift(fft2(arydSubE,fftsize,fftsize))).^2;
