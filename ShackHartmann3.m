...
%%
randcoe1=[0,0,5,0,0,0,0,0,0,0,0]';
...
% figure;
% mesh(wf);
[aryActCx, aryActCy, I_act] = HS_SubCentroidAry(wf1, valueAry,mask1, wl, L_pixel, subPixel,3e-3 ,b_digital, nBytes);
[aryActCx1, aryActCy1, I_act1] = HS_SubCentroidAry(wf1, valueAry,mask1, wl, L_pixel, subPixel,3.5e-3, b_digital, nBytes);
